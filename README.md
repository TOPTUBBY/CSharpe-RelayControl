...
- **ESP8266:** ตารางและสเก็ตช์เรียง CH1–CH8 ตามป้าย `D0–D7` สำหรับบอร์ด NodeMCU ที่มี D0–D4 อยู่ฝั่งหนึ่งและ D5–D7 อยู่อีกฝั่ง; หากใช้ D1 mini หรือบอร์ดรุ่นอื่น ตำแหน่งขาแต่ละฝั่งอาจต่างกัน ให้ยึด **ป้าย D0–D7 บนบอร์ดจริง** และตารางแทนการเดาว่าขาอยู่ฝั่งใด GPIO0/D3 (CH4) และ GPIO2/D4 (CH5) เป็นสองขา ⚠ ที่เลี่ยงไม่ได้เมื่อขับรีเลย์ 8 ช่องตรงและคง USB Serial อย่าใช้ GPIO15/D8 ซึ่งต้อง LOW ตอนบูต หรือ GPIO1/3 ที่ใช้ Serial กับ GUI
